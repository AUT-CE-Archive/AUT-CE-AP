...
import static com.company.GameManager.isSinglePlayer;
...
public class Player implements Serializable {
    ...
    private long startTime;                 // Player start time
    private long endTime;                   // Player end time
    private boolean saved = false;          // Player saved status
     ...
     */
    Player(String name, String tankName, int x, int y, String teamID, String explosiveName, boolean isAI, String playerID, boolean isME, int health, int bombDamage, int missileDamage) {
        this.name = name;
        this.deathCount = 0;
        this.killCount = 0;
        this.isAI = isAI;
        ...
        // Initialize tank
        tank = isAI ? new TankAI(tankName, x, y, explosiveName, health, bombDamage, missileDamage) : new Tank(tankName, x, y, explosiveName, health, bombDamage, missileDamage);
    }
