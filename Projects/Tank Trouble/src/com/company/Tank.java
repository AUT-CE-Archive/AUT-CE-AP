...
public class Tank {
    ...
    protected int bombDamage = 15;
    protected int missileDamage = 25;

    // Care packages
    protected boolean activateBuff;                           // Tank's active buff status (Power care package)
    protected boolean shield;                                 // Tank's shield status (Shield care package)
    protected boolean ghost;                                  // Tank's ghost status (Ghost care package) (Ghost through walls and stuff)
     ...
     */
    public Tank(String tankName, int x, int y, String explosiveName, int health, int bombDamage, int missileDamage) {
        ...
        this.health = health;                           // Default value (Startup value)
    ...
    public Explosive fire() {
        ...
        switch (explosiveName) {
            case "bomb":
                return new Bomb(xTemp, yTemp, this.rotation, 6 * explosiveSpeedCoefficient, bombDamage * firePowerCoefficient, this.scale, 5, 5, this.color);
            case "missile":
                return new Missile(xTemp, yTemp, this.rotation, 7 * explosiveSpeedCoefficient, missileDamage * firePowerCoefficient, this.scale, 5, 5, this.color);
        }
