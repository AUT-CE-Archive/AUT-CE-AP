...
public class TankAI extends Tank {
     ...
     */
    public TankAI(String tankName, int x, int y, String explosiveName, int health, int bombDamage, int missileDamage) {
        super(tankName, x, y, explosiveName, health, bombDamage, missileDamage);
